    ...
    public class Utils
    {
        ...
        public static string parseFormulario(FormularioRequest formulario)
        {
            string text = "Crie uma prova de " + formulario.Materia + " para alunos do " + formulario.Ano +
                ...
                + " Retorne somente a prova com estrutura de JSON com os seguintes atributos: -questoes: a lista de questões; -cada questão terá:  -enunciado com uma história que se relacione à pergunta da questão;  -resposta correta; ";
